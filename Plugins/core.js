    ...
    switch (inputCMD) {
      ...
      case "sc":
        ...
        let repoInfo = await axios.get(
          "https://api.github.com/repos/botskaking/Makima-MD"
        );
        ...
        let txt = `            🧣 *${botName}'s Script* 🧣\n\n*🎀 Total Forks:* ${
          ...
          repo.html_url
        }\n\n❝ Dont forget to give a Star ⭐ to the repo. It's made with restless hardwork by *Team TRIDENT*. ❞\n\n*©️ Team TRIDENT- 2024*`;
      ...
      case "about":
        ...
        let xyz = await axios.get(
          "https://api.github.com/repos/botskaking/Makima-MD/releases"
        );
